...
/*
ActivitiesApiService Delete Activity
Deletes the given activity that is owned by the authenticated athlete. Requires activity:write. Also requires activity:read_all in order to update Only Me activities
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The identifier of the activity.
*/

func (a *ActivitiesApiService) DeleteActivityById(ctx context.Context, id int64) (*http.Response, error) {
	var (
