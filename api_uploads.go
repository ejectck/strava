 ...
 * @param optional nil or *CreateUploadOpts - Optional Parameters:
     ...
     * @param "Trainer" (optional.Int32) -  Whether the resulting activity should be marked as having been performed on a trainer.
     * @param "Commute" (optional.Int32) -  Whether the resulting activity should be tagged as a commute.
